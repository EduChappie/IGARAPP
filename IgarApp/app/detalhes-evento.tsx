...
// Imagens de fallback para o carrossel (usadas quando o evento não tem imagens)
const EVENT_IMAGES_FALLBACK = [
...
export default function DetalhesEventoScreen() {
  ...
  // Carregar evento e verificar participação
  useEffect(() => {
  ...
  // Tela de loading enquanto carrega o evento
  if (carregandoEvento) {
    return (
      <View style={[styles.mainContainer, { justifyContent: "center", alignItems: "center" }]}>
        <StatusBar barStyle="light-content" backgroundColor="transparent" translucent />
        <ActivityIndicator size="large" color="#EEE82C" />
        <Text style={{ color: "#E8F1F2", marginTop: 12, fontSize: 14, fontWeight: "300" }}>
          Carregando evento...
        </Text>
      </View>
    );
  ...
  // Derivar dados dinâmicos do estado
  ...
  // Imagens do evento: usa URLs do Firestore/Cloudinary ou fallback local
  const imagensEvento =
    acao?.imagens && acao.imagens.length > 0
      ? acao.imagens.map((url) => ({ uri: url }))
      : EVENT_IMAGES_FALLBACK;
  ...
  return (
    <View style={styles.mainContainer}>
              ...
              {acao?.metas && acao.metas.length > 0 ? (
                ...
                <View style={styles.glassPill}>
                  <BlurView
                    ...
                    style={StyleSheet.absoluteFillObject}
                  />
                  <Text style={styles.glassPillText}>Nenhuma meta informada</Text>
                </View>
              )}
            </View>
          </View>
      ...
      {/* 5. MODAL DE SUCESSO CUSTOMIZADO */}
      <SuccessModal
  ...
  >
    ...
    <View style={modalStyles.overlay}>
      <BlurView
        ...
        style={StyleSheet.absoluteFillObject}
      />
      <View style={[StyleSheet.absoluteFillObject, { backgroundColor: "rgba(0, 26, 35, 0.55)" }]} />
      ...
      <View style={modalStyles.card}>
        ...
        {/* Textos */}
        <Text style={modalStyles.title}>Inscrição confirmada!</Text>
        <Text style={modalStyles.subtitle}>
          Você agora faz parte do evento
        </Text>
        <Text style={modalStyles.eventName}>{titulo}</Text>
        ...
        <Text style={modalStyles.infoText}>
          Fique atento às orientações e apareça no dia combinado. Cada voluntário faz a diferença. 🌿
        </Text>
        ...
        >
          <LinearGradient
            ...
            style={StyleSheet.absoluteFillObject}
          />
          <Text style={modalStyles.buttonText}>Perfeito!</Text>
        </TouchableOpacity>
      </View>
    </View>
  </Modal>
...
const modalStyles = StyleSheet.create({
  ...
  card: {
    ...
    backgroundColor: "rgba(0, 44, 59, 0.6)",
    overflow: "hidden",
    alignItems: "center",
    paddingHorizontal: 28,
    paddingTop: 40,
  ...
  iconWrapper: {
    ...
    marginBottom: 24,
    borderWidth: 1,
    borderColor: "rgba(238, 232, 44, 0.4)",
  },
  title: {
    color: "#EEE82C",
    fontSize: 22,
...
// ==========================================
// ESTILOS — base 100% do Código 2 (visual)
// ==========================================
