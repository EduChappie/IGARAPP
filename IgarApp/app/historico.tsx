...
// ==========================================
// DADOS DOS CARDS DE HISTÓRICO
// ==========================================
const HISTORICO_FEED_DATA = [
  {
    id: "h1",
    orgName: "Igarape S.P.",
    title: "Limpeza Igarapé do Franco",
    subtitle: "Manaus, Amazonas",
    volunteers: "45 Voluntários",
    date: "10/02/2026",
    time: "08:00H - 12:00H",
    images: [
  ...
  },
  {
    id: "h2",
    orgName: "Igarape S.P.",
    title: "Ação Praia do Tupé",
    subtitle: "Manaus, Amazonas",
    volunteers: "120 Voluntários",
    date: "15/01/2026",
    time: "09:00H - 16:00H",
    images: [
      require("../src/assets/image_card_1.png"),
...
export default function HistoricoScreen() {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      >
        <SafeAreaView>
          ...
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Histórico de Ações</Text>
            <Text style={styles.descriptionHeader}>
              Acompanhe o impacto que você já gerou para a preservação da nossa
              Amazônia.
            </Text>
          </View>
      ...
      {/* BOTTOM TAB BAR (COM BOTÃO HISTÓRICO ATIVO) */}
    ...
    <View style={styles.cardContainer}>
      ...
      >
        ...
        <View style={styles.carouselContainer}>
          {/* TAG FINALIZADO ABSOLUTA SOBRE O CARROSSEL */}
          <View style={styles.tagFinalizadoContainer}>
            <Text style={styles.tagFinalizadoText}>Finalizado</Text>
          </View>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.imageWrapper}>
                ...
                >
                  {/* BLUR FORTE APENAS NA IMAGEM PARA INDICAR HISTÓRICO */}
                  <BlurView
                    intensity={100}
                    tint="dark"
        ...
        {/* PILL (RODAPÉ DO CARD) IDÊNTICO À HOME */}
...
const HistoryIconActive = () => (
  <Svg width="54" height="55" viewBox="0 0 54 55" fill="none">
    ...
    <Path
      ...
      strokeOpacity="0.4"
    />
    <G transform="translate(17, 17) scale(1.1)">
      <Path
